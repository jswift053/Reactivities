            ...
            case Status.Failed:
                return (
                    <div>
                        ...
                        <Button primary onClick={handleConfirmEmailResend} size='huge' content='Resend email'></Button>
                    </div>
                );
            case Status.Success:
                return(
                    <div>
                        ...
                        <Button primary onClick={() => modalStore.openModal(<LoginForm />)} size='huge' content='Login'></Button>
                    </div>
                );
        }
    }
